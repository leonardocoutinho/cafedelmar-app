...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Lunch2PageModule", function() { return Lunch2PageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lunch__ = __webpack_require__(669);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(523);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__ = __webpack_require__(301);
...
var Lunch2PageModule = /** @class */ (function () {
    function Lunch2PageModule() {
    }
    Lunch2PageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__lunch__["a" /* LunchPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__lunch__["a" /* LunchPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["a" /* IonicImageViewerModule */]
            ],
        })
    ], Lunch2PageModule);
    return Lunch2PageModule;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_offline_data_offline_data__ = __webpack_require__(299);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LunchPage = /** @class */ (function () {
    function LunchPage(navCtrl, navParams, modalCtrl, offlineData) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
    ...
    LunchPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.offlineData.getLocalData().subscribe(function (data) {
            var object = JSON.parse(JSON.stringify(data));
            // const resp = JSON.parse(object);
            console.log('DATA1: ', object);
            _this.lunch1 = object.lunch;
        });
    };
    LunchPage.prototype.retrieveData = function (page) {
    };
    LunchPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-lunch2',template:/*ion-inline-start:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/lunch/lunch.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Lunch\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-12>\n        <h3>Appetizer</h3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <ion-slides style="height: 110px; background: #fafafa;" class="image-slider" loop="true" slidesPerView="2">\n    <ion-slide *ngFor="let img of[1, 2, 3, 4, 5]">\n      <img src="../../assets/lunch/lunch{{img}}.jpg" alt="" class="thumb-img" imageViewer>\n    </ion-slide>\n  </ion-slides>\n\n  <hr>\n\n<ion-card *ngFor="let lunch of lunch1">\n\n  <ion-card-header>\n    {{lunch.title}}\n  </ion-card-header>\n  <ion-card-content>\n    <p>{{lunch.details}}</p>\n  </ion-card-content>\n</ion-card>\n\n  <cards-component *ngFor="let lunch of lunch1" [lunchmenu]="lunch"></cards-component>\n</ion-content>\n'/*ion-inline-end:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/lunch/lunch.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ModalController */], __WEBPACK_IMPORTED_MODULE_2__providers_offline_data_offline_data__["a" /* OfflineDataProvider */]])
    ], LunchPage);
    return LunchPage;
}());
