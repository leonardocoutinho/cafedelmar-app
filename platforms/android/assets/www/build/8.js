...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BreakfastModule", function() { return BreakfastModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__breakfast__ = __webpack_require__(656);
...
var BreakfastModule = /** @class */ (function () {
    function BreakfastModule() {
    }
    BreakfastModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__breakfast__["a" /* Breakfast */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__breakfast__["a" /* Breakfast */]),
...
var Breakfast = /** @class */ (function () {
    function Breakfast(service, navCtrl, navParams, favorites) {
        this.service = service;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.favorites = favorites;
        this.currentPage = 'Breakfast';
        // Active filter rules
        this.filters = {};
        //  this.currentPage = this.navParams.get('page');
    }
    Breakfast.prototype.sendFavorites = function (items) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Breakfast.prototype.ionViewWillLoad = function () {
        this.menuFoodsRef$ = this.service.getMenuFood(this.currentPage);
    ...
    //    })
    // }
    Breakfast.prototype.filterFood = function (ev) {
    ...
    Breakfast = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-breakfast',template:/*ion-inline-start:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/breakfast/breakfast.html"*/'<ion-header>\n <ion-navbar color="primary">\n  <header-component [currentPage]="currentPage" (filterFoods)="filterFood($event)" ></header-component>\n  <!-- <ion-title  class="header-component_title-page" >\n      {{currentPage}}\n    </ion-title>\n      <ion-buttons end class="buttons_header-component">\n      <button ion-button icon-only navPush="Search" [navParams]="{page: currentPage}" >\n          <ion-icon name="search"></ion-icon>\n      </button>\n\n      <button ion-button icon-only (click)="filterFood($event)">\n          <ion-icon name="funnel"></ion-icon>\n      </button>\n   </ion-buttons> -->\n</ion-navbar>\n</ion-header>\n\n<ion-content>\n\n    <ion-card *ngFor="let menuFood of menuFoodsRef$ | async">\n\n      <ion-item>\n        <h2>{{menuFood.title}}</h2>\n        <p>{{menuFood.details}}</p>\n        <button ion-button item-right icon-only outline (tap)="sendFavorites(menuFood)" >\n          Add\n        </button>\n      </ion-item>\n\n      <img *ngIf="menuFood.image" [src]="menuFood.image"/>\n\n      <ion-card-content>\n        <p>{{menuFood.description}}</p>\n      </ion-card-content>\n\n      </ion-card>\n  </ion-content>\n'/*ion-inline-end:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/breakfast/breakfast.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_menu_service_menu_service__["a" /* MenuService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__providers_favorites_favorites__["a" /* FavoritesProvider */]])
    ], Breakfast);
    return Breakfast;
}());
