...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__drinks__ = __webpack_require__(662);
...
var DrinksModule = /** @class */ (function () {
    function DrinksModule() {
    }
    DrinksModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__drinks__["a" /* Drinks */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__drinks__["a" /* Drinks */]),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Drinks; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_drinks_service_drinks_service__ = __webpack_require__(298);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Drinks = /** @class */ (function () {
    function Drinks(app, navParams, drinksService) {
        this.app = app;
        this.navParams = navParams;
        this.drinksService = drinksService;
        this.currentPage = this.navParams.get('page');
    }
    Drinks.prototype.ionViewDidLoad = function () {
        this.drinksRef$ = this.drinksService.getDrinks(this.currentPage);
    };
    Drinks.prototype.back = function () {
        this.app.getRootNav().setRoot('Menu');
    };
    Drinks.prototype.filterDrinks = function (ev) {
    ...
    Drinks = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-drinks',template:/*ion-inline-start:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/drinks/drinks.html"*/'<ion-header>\n    <ion-navbar color="primary">\n        <ion-buttons left>\n            <button ion-button  (click)="back()" >\n                <ion-icon name="arrow-back"></ion-icon>\n            </button>\n        </ion-buttons>\n  <header-component [currentPage]="currentPage" (filterDrinks)="filterDrinks($event)" ></header-component>\n  </ion-navbar>\n  </ion-header>\n\n  <ion-content>\n\n    <ion-card *ngFor="let drinkContent of drinksRef$ | async" color="light" style="font-size: 22px" >\n       <ion-card-header >\n         {{ drinkContent.title }}\n       </ion-card-header>\n\n       <ion-list inset *ngFor="let drinks of drinkContent.drinkType | async" >\n         <button ion-item detail-none [disabled]="drinks.disable">\n            {{ drinks.drink }}\n         </button>\n\n      </ion-list>\n\n\n   </ion-card>\n\n   <!-- <ng-template #loading>\n     <ion-spinner></ion-spinner>\n   </ng-template> -->\n\n\n\n</ion-content>\n'/*ion-inline-end:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/drinks/drinks.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* App */],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_drinks_service_drinks_service__["a" /* DrinksService */]])
    ], Drinks);
    return Drinks;
}());
