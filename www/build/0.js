webpackJsonp([0],Array(519).concat([
/* 519 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__news__ = __webpack_require__(672);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(523);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pipes_pipes_module__ = __webpack_require__(673);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(676)(module)))
...
var NewsPage = /** @class */ (function () {
    function NewsPage(service, navCtrl, navParams, modalCtrl) {
        this.service = service;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.newsData = new Array(6);
    }
    NewsPage.prototype.ionViewDidLoad = function () {
        this.newsRef$ = this.service.getNews();
    };
    NewsPage.prototype.openModal = function (data) {
        var modal = this.modalCtrl.create('ModalPage', { content: data });
        modal.present();
    };
    NewsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-news',template:/*ion-inline-start:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/news/news.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Breaking News</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <div *ngFor="let news of newsRef$ | async">\n    <ion-card *ngIf="news.featured === true" style="box-shadow: 0px 0px 0px 0px; background-color: whitesmoke; " (tap)="openModal(news)">\n      <!-- <img *ngIf="news.image" [src]="news.image">\n       -->\n       <img src="http://www.flynight.fr/797-nq_social_share/flyer-party-event-beach-party.jpg" alt="">\n      <ion-card-content>\n        <ion-card-title style="font-weight: bold; font-family: lato;">\n          {{ news.title }}\n          <button text-right ion-button ion-icon clear large outline color="dark">\n            <ion-icon name="ios-star"></ion-icon>\n          </button>\n        </ion-card-title>\n        <p>Posted: {{ news.date | moment }} </p>\n      </ion-card-content>\n    </ion-card>\n  </div>\n\n    <ion-list inset no-lines>\n      <ion-item *ngFor="let news of (newsRef$ | async)?.slice().reverse()" [ngClass]="{\'ligado\': news.featured, \'desligado\': !news.featured}" (tap)="openModal(news)">\n        <ion-thumbnail item-end>\n          <!-- <img *ngIf="news.image" [src]="news.image"> -->\n          <img src="http://www.flynight.fr/797-nq_social_share/flyer-party-event-beach-party.jpg" alt="">\n        </ion-thumbnail>\n        <h2> {{ news.title }} </h2>\n        <p>Posted: {{ news.date | moment }} </p>\n      </ion-item>\n    </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/news/news.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_menu_service_menu_service__["a" /* MenuService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ModalController */]])
    ], NewsPage);
    return NewsPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__capitalize_capitalize__ = __webpack_require__(674);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__moment_moment__ = __webpack_require__(675);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    PipesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__moment_moment__["a" /* MomentPipe */]
            ],
            imports: [],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment__ = __webpack_require__(522);
...
var MomentPipe = /** @class */ (function () {
    ...
    MomentPipe.prototype.transform = function (value) {
        var date = __WEBPACK_IMPORTED_MODULE_1_moment__(value).startOf('minute').fromNow();
        return date;
    };
