...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__intro__ = __webpack_require__(667);
...
var IntroModule = /** @class */ (function () {
    ...
    IntroModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__intro__["a" /* Intro */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_facebook__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_login_service_login_service__ = __webpack_require__(302);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Intro = /** @class */ (function () {
    function Intro(afAuth, fb, platform, navCtrl, menuCtrl, loginProvider) {
        this.afAuth = afAuth;
        this.fb = fb;
        this.platform = platform;
        this.navCtrl = navCtrl;
    ...
    Intro.prototype.signInWithFacebook = function () {
        var _this = this;
        if (this.platform.is('cordova')) {
            // é um telemovel
            this.fb.login(['email', 'public_profile']).then(function (res) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_3_firebase_app__["auth"])().signInWithCredential(facebookCredential).then(function (login) {
            ...
            }).catch(function (error) { return console.log('ERROROR: ', error); });
        }
    };
    Intro.prototype.ionViewDidEnter = function () {
        this.menuCtrl.enable(false, 'myMenu');
    };
    Intro.prototype.ionViewWillLeave = function () {
        this.menuCtrl.enable(true, 'myMenu');
    };
    Intro.prototype.closeIntro = function () {
        this.navCtrl.setRoot('HomePage');
    };
    Intro = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-intro',template:/*ion-inline-start:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/intro/intro.html"*/'<ion-slides pager>\n\n  <ion-slide class="profile-view__image-container">\n    <h1 style="color:#fff;"> Bem-Vindo ao <br><strong>Café Del Mar</strong> </h1>\n    <h2 style="color:#fff"> Um conceito único em Luanda </h2>\n  </ion-slide>\n\n\n  <ion-slide class="bg-image">\n    <h3 style="color:#fff;">Desfrute do melhor espaço</h3>\n    <p style="color:#fff;">já conhecido em Luanda</p>\n  </ion-slide>\n\n\n  <ion-slide class="social-image" style="color: #fff">\n    <h3> Connecta a sua rede social favorita ao nosso app </h3>\n    <h2> Partilha imagens do nosso espaço e dos nossos pratos com os teus amigos</h2>\n    <p> Adicione os seus pratos preferidos à secção de favoritos </p>\n  </ion-slide>\n\n\n  <ion-slide style="background-color: #fff">\n    <h2 style="color:dimgray">Login</h2>\n    <!-- <ion-row>\n      <ion-col>\n        <button ion-button round large color="google" (click)="nativeGoogleLogin()">\n          <ion-icon name="logo-google"></ion-icon>\n        </button>\n      </ion-col>\n      <ion-col>\n        <button ion-button round large (click)="signInWithFacebook()" color="facebook">\n          <ion-icon name="logo-facebook"></ion-icon>\n        </button>\n      </ion-col>\n    </ion-row> -->\n    <app-login></app-login>\n    <br>\n    <button ion-button block (click)="closeIntro()"color="primary">Começar</button>\n  </ion-slide>\n</ion-slides>\n'/*ion-inline-end:"/home/leonardo/3ionicprojects/cafedelmar/src/pages/intro/intro.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__["AngularFireAuth"], __WEBPACK_IMPORTED_MODULE_4__ionic_native_facebook__["a" /* Facebook */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* MenuController */], __WEBPACK_IMPORTED_MODULE_5__providers_login_service_login_service__["a" /* LoginProvider */]])
    ], Intro);
    return Intro;
}());
